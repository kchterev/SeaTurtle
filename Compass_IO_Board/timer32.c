/****************************************************************************
 *   $Id:: timer32.c 3871 2010-07-16 11:50:22Z gerritdewaard                $
...
void init_timer32(uint8_t timer_num, uint32_t TimerInterval) 
{
  if ( timer_num == 0 )
  {
    ...
    LPC_IOCON->PIO2_7 |= 0x02;	    /* Timer0_32 MAT2 */
...
//	  	LPC_IOCON->PIO1_6           |= 0x02;		/* Timer0_32 MAT0 */
    ...
    if (match_enable & 0x04)
    {
      ...
      //change to
      LPC_IOCON->PIO2_7  &= ~0x07;
      LPC_IOCON->PIO2_7  |= 0x01;					/* Timer0_32 MAT2 */
      //
    }
    /* If match3 is enabled, set the output */
    if (match_enable & 0x08)
...
#endif //CONFIG_ENABLE_DRIVER_TIMER32
/******************************************************************************
**                            End Of File
******************************************************************************/
